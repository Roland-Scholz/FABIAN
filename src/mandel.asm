...
iteration_max:   db    30                      ; How many iterations
x:               dw    0                       ; x-coordinate
x_start:         dw    -2 * scale              ; Minimum x-coordinate
x_end:           dw    1 * scale               ; Maximum x-coordinate
x_step:          dw    scale / 80              ; x-coordinate step-width
y:               dw    -5 * scale / 4          ; Minimum y-coordinate
y_end:           dw    5 * scale / 4           ; Maximum y-coordinate
y_step:          dw    scale / 60              ; y-coordinate step-width
z_0:             dw    0
z_1:             dw    0
scratch_0:       dw    0
...
hsv:             db 0                          ; hsv color table
                db 201, 200, 199, 198, 197
                db 196, 202, 208, 214, 220
                db 226, 190, 154, 118, 82
                db 46, 47, 48, 49, 50
                db 51, 45, 39, 33, 27
                db 21, 57, 93, 129, 165
...
crlf:            db    cr, lf, eos
finished:        db    esc, "[0mComputation finished.", cr, lf, eos
ansifg:          db    esc, "[38;5;", eos
ansibg:          db    esc, "[48;5;", eos
